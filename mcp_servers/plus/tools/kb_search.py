"""KB Search Tool — embeds the query, searches mcp-plus's Qdrant collection."""
...
async def kb_search(query: str, top_k: int = 5) -> list[dict]:
    """Search MCN+'s knowledge base (SOPs, internal documentation covering
    both streaming and shorts) for chunks relevant to `query`. Returns
    matching chunks with source metadata."""
