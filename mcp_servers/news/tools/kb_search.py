"""KB Search Tool — embeds the query, searches mcp-news's Qdrant collection."""
...
async def kb_search(query: str, top_k: int = 5) -> list[dict]:
    """Search MCN News's knowledge base (SOPs, internal documentation) for
    chunks relevant to `query`. Returns matching chunks with source metadata."""
