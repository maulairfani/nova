"""One-off seed script: embeds the committed dummy MCN News SOP markdown docs
...
NAMESPACE = uuid.UUID("8b2e1d3c-8a8d-4a4a-be4c-4b8c4b8c4b8c")  # fixed, for deterministic point IDs
