"""One-off seed script: embeds the committed dummy MCN TV SOP markdown docs
...
NAMESPACE = uuid.UUID("6f9c9b1a-6e6b-4e2e-9c2a-2f6a2f6a2f6a")  # fixed, for deterministic point IDs
